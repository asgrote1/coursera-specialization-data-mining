...
def submit():   
  ...
  print 'Check the feedback in the submissions page.'
...
partIds = ['1ELJwtZ5','iksAJLbk','wt2iMfjm']

partFriendlyNames = ['Relevance Judgements', 'Competition', 'Description - Optional'] 

sourceFiles = ['new-judgements.txt', 'output.txt', 'description.txt']                        
          
def output(partIdx):
  outputString = ''

  if partIdx == 0:
    infile = open("new-judgements.txt")
    for line in infile:
      outputString += line
